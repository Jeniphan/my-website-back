    ...
    const Contacts = prisma.contacts.createMany({
        data: [
            ...
            },
            {
                ...
                authorId: Id,
                platFormLink: 'https://www.linkedin.com/in/jetniphan-pukkham-957671212/',
                createAt: new Date(),
                updateAt: new Date(),
            },
            {
                ...
                authorId: Id,
                platFormLink: 'https://mail.google.com/mail/u/0/?view=cm&ui=2&tf=0&fs=1&to=jeni.pukkham@gmail.com',
                createAt: new Date(),
                updateAt: new Date(),
            },
            {
